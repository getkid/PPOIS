...
TEST(Tests, Test3) {
	...
	EXPECT_EQ(0, drob3.fr_to_double());
...
TEST(Tests, Test11) {
	...
	Fraction drob2(1, -3);
	Fraction drob3 = drob1 + drob2;
	EXPECT_EQ(16.0 / 30, drob3.fr_to_double());
	drob3 = drob1 - drob2;
	EXPECT_EQ(-4.0 / 30, drob3.fr_to_double());
	drob3 = drob1 * drob2;
	EXPECT_EQ(2.0 / 30, drob3.fr_to_double());
	drob3 = drob1 / drob2;
	EXPECT_EQ(6.0 / 10, drob3.fr_to_double());
	EXPECT_EQ(1, drob1.getNum());
	EXPECT_EQ(0, drob1.getInt());
	EXPECT_EQ(3, drob2.getDenom());
	drob1--;
	EXPECT_EQ(-8.0 / 10, drob1.fr_to_double());
	EXPECT_FALSE(drob1 > 1);
	drob2 /= drob1;
	EXPECT_EQ(-10.0 / 24, drob2.fr_to_double());
	drob1 *= 2;
	EXPECT_EQ(-16.0 / 10, drob1.fr_to_double());
	drob1 /= -3;
	EXPECT_EQ(16.0 / 30, drob1.fr_to_double());
	drob2 += 1;
	EXPECT_EQ(14.0 / 24, drob2.fr_to_double());
	EXPECT_TRUE(drob1 < drob2);
	EXPECT_FALSE(drob1 <= 1);
}
